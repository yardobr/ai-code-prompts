...
7. Produce the required output in this order:
  ...
  - supporting evidence
  - full change table
8. The **full change table must be the final section** of the output. Do not place any narrative sections after it.
...
After the overview, group evidence by semantic change.
...
Place this section **at the very end** of the output.
